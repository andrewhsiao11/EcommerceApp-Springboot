...
import com.tts.ecommerce.ecommerce.model.User;
import com.tts.ecommerce.ecommerce.service.ProductService;
import com.tts.ecommerce.ecommerce.service.UserService;
...
public class CartController {
    ...
    // puts an empty list  in the model that thymeleaf
    // can use to sum up the cart total
